...
<div id="main_div" style="width:100%">
  ...
  <div class="slider-container">
    <div class="horizontal-slider">
      ...
      <input type="range" id="brightness" style="width:100%;" min="1" max="16" step="1" style="display:inline-flex;" name="vertical-range" min="0" max="255" orient="vertical" placeholder="brightness">
    </div>
  </div>
